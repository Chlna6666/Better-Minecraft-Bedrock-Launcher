...
// 动画时长与 render/card.rs 的弹簧窗口对齐（spring_smooth ≈ 640ms 稳定，
// spring_snappy ≈ 600ms 稳定），清理定时器不能早于弹簧收敛。
const TASK_CARD_ENTER_ANIMATION_MS: u64 = 640;
const TASK_CARD_COMPLETE_ANIMATION_MS: u64 = 640;
const TASK_CARD_WARNING_ANIMATION_MS: u64 = 640;
const TASK_CARD_EXIT_ANIMATION_MS: u64 = 600;
