...
pub struct DownloadPageState {
    ...
    pub native_mods_loaded: bool,
    pub native_mods_loading: bool,
    pub native_mods_error: Option<SharedString>,
    pub native_mods: Vec<crate::core::native_mods::NativeModEntry>,
...
impl Default for DownloadPageState {
    fn default() -> Self {
        Self {
            ...
            native_mods_loaded: false,
            native_mods_loading: false,
            native_mods_error: None,
            native_mods: Vec::new(),
