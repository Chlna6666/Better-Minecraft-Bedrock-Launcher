...
struct RealtimeWindowMetric {
    ...
    frame_duration_p50_micros: usize,
    frame_duration_p95_micros: usize,
    frame_duration_p99_micros: usize,
    frame_duration_sample_count: usize,
    present_interval_p50_micros: usize,
    present_interval_p95_micros: usize,
    present_interval_p99_micros: usize,
    present_interval_sample_count: usize,
...
fn main_window_realtime_metric(
    ...
    Some(RealtimeWindowMetric {
        ...
        frame_duration_p50_micros: window.frame_duration_p50_micros,
        frame_duration_p95_micros: window.frame_duration_p95_micros,
        frame_duration_p99_micros: window.frame_duration_p99_micros,
        frame_duration_sample_count: window.frame_duration_sample_count,
        present_interval_p50_micros: window.present_interval_p50_micros,
        present_interval_p95_micros: window.present_interval_p95_micros,
        present_interval_p99_micros: window.present_interval_p99_micros,
        present_interval_sample_count: window.present_interval_sample_count,
...
fn window_metrics_summary(runtime: &DebugRuntimeSnapshot) -> String {
    ...
    runtime
        ...
        .map(|window| {
            ...
            format!(
                "#{} ({}) fps={:.1} frame_p50/p95/p99={:.2}/{:.2}/{:.2}ms(n={}) present_p50/p95/p99={:.2}/{:.2}/{:.2}ms(n={}) d2p_avg={:.2}ms d2p_max={:.2}ms d2p_n={} active={} minimized={} size={:.0}x{:.0}@{:.2}x redraw={} draw={} present={} skip={} skipped={} reconfig={} errors={} layout={} upload={}",
                window.window_id,
                role,
                window.present_fps_milli as f32 / 1000.0,
                window.frame_duration_p50_micros as f32 / 1000.0,
                window.frame_duration_p95_micros as f32 / 1000.0,
                window.frame_duration_p99_micros as f32 / 1000.0,
                window.frame_duration_sample_count,
                window.present_interval_p50_micros as f32 / 1000.0,
                window.present_interval_p95_micros as f32 / 1000.0,
                window.present_interval_p99_micros as f32 / 1000.0,
