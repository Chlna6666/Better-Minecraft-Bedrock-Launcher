...
impl Agent {
    ...
    /// Returns aggregate STUN connectivity-check counters.
    pub fn get_connectivity_check_stats(&self) -> ConnectivityCheckStats {
        self.internal.get_connectivity_check_stats()
    }
