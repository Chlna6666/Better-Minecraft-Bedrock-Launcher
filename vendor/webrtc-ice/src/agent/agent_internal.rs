...
pub struct AgentInternal {
    ...
    pub(crate) binding_requests_received: AtomicU64,
    pub(crate) binding_requests_sent: AtomicU64,
    pub(crate) binding_responses_received: AtomicU64,
    pub(crate) binding_responses_sent: AtomicU64,
...
impl AgentInternal {
    pub(super) fn new(config: &AgentConfig) -> (Self, ChanReceivers) {
        ...
        let ai = AgentInternal {
            ...
            binding_requests_received: AtomicU64::new(0),
            binding_requests_sent: AtomicU64::new(0),
            binding_responses_received: AtomicU64::new(0),
            binding_responses_sent: AtomicU64::new(0),
    ...
    pub(crate) async fn send_binding_request(
        ...
        self.binding_requests_sent.fetch_add(1, Ordering::Relaxed);
    ...
    pub(crate) async fn send_binding_success(
        ...
        if let Err(err) = result {
            ...
            self.binding_responses_sent.fetch_add(1, Ordering::Relaxed);
    ...
    pub(crate) async fn handle_inbound(
        ...
        if m.typ.class == CLASS_SUCCESS_RESPONSE {
            ...
            self.binding_responses_received
            ...
            self.binding_requests_received
                .fetch_add(1, Ordering::Relaxed);
