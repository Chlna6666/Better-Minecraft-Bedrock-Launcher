use crate::{
    ...
    TextAlign, TextBackgroundPadding, UnderlineStyle, Window, WrapBoundary, WrappedLineLayout,
...
fn snap_baseline_offset_to_device_pixels(
    origin_y: Pixels,
...
fn max_background_padding(decoration_runs: &[DecorationRun]) -> TextBackgroundPadding {
