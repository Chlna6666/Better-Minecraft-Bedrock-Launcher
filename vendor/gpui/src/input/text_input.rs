...
/// This input handler can then be assigned during paint by calling [`Window::set_input_handler`].
///
...
/// The canonical implementation of [`crate::PlatformInputHandler`]. Call [`Window::set_input_handler`]
