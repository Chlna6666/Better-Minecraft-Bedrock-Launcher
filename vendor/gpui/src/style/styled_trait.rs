...
fn ensure_default<T: Default>(option: &mut Option<T>) -> &mut T {
    match option {
        Some(value) => value,
        None => option.insert(T::default()),
    }
}

fn ensure_text_style(style: &mut Option<TextStyleRefinement>) -> &mut TextStyleRefinement {
    ensure_default(style)
}
...
pub trait Styled: Sized {
    ...
    fn whitespace_normal(mut self) -> Self {
        ensure_text_style(self.text_style()).white_space = Some(WhiteSpace::Normal);
        self
    }
    ...
    fn whitespace_nowrap(mut self) -> Self {
        ensure_text_style(self.text_style()).white_space = Some(WhiteSpace::Nowrap);
        self
    }
    ...
    fn text_ellipsis(mut self) -> Self {
        ensure_text_style(self.text_style()).text_overflow = Some(TextOverflow::Truncate(ELLIPSIS));
        self
    }

    /// Sets the text overflow behavior of the element.
    fn text_overflow(mut self, overflow: TextOverflow) -> Self {
        ensure_text_style(self.text_style()).text_overflow = Some(overflow);
        self
    }

    /// Set the text alignment of the element.
    fn text_align(mut self, align: TextAlign) -> Self {
        ensure_text_style(self.text_style()).text_align = Some(align);
        self
    }
    ...
    fn line_clamp(mut self, lines: usize) -> Self {
        let mut text_style = ensure_text_style(self.text_style());
    ...
    fn text_color(mut self, color: impl Into<Hsla>) -> Self {
        ensure_text_style(self.text_style()).color = Some(color.into());
        self
    }
    ...
    fn font_weight(mut self, weight: FontWeight) -> Self {
        ensure_text_style(self.text_style()).font_weight = Some(weight);
        self
    }
    ...
    fn text_bg(mut self, bg: impl Into<Hsla>) -> Self {
        ensure_text_style(self.text_style()).background_color = Some(bg.into());
        self
    }
    ...
    fn text_size(mut self, size: impl Into<AbsoluteLength>) -> Self {
        ensure_text_style(self.text_style()).font_size = Some(size.into());
        self
    }
    ...
    fn text_xs(mut self) -> Self {
        ensure_text_style(self.text_style()).font_size = Some(rems(0.75).into());
        self
    }
    ...
    fn text_sm(mut self) -> Self {
        ensure_text_style(self.text_style()).font_size = Some(rems(0.875).into());
        self
    }
    ...
    fn text_base(mut self) -> Self {
        ensure_text_style(self.text_style()).font_size = Some(rems(1.0).into());
        self
    }
    ...
    fn text_lg(mut self) -> Self {
        ensure_text_style(self.text_style()).font_size = Some(rems(1.125).into());
        self
    }
    ...
    fn text_xl(mut self) -> Self {
        ensure_text_style(self.text_style()).font_size = Some(rems(1.25).into());
        self
    }
    ...
    fn text_2xl(mut self) -> Self {
        ensure_text_style(self.text_style()).font_size = Some(rems(1.5).into());
        self
    }
    ...
    fn text_3xl(mut self) -> Self {
        ensure_text_style(self.text_style()).font_size = Some(rems(1.875).into());
        self
    }
    ...
    fn italic(mut self) -> Self {
        ensure_text_style(self.text_style()).font_style = Some(FontStyle::Italic);
        self
    }
    ...
    fn not_italic(mut self) -> Self {
        ensure_text_style(self.text_style()).font_style = Some(FontStyle::Normal);
        self
    }
    ...
    fn underline(mut self) -> Self {
        let style = ensure_text_style(self.text_style());
    ...
    fn text_decoration_none(mut self) -> Self {
        ensure_text_style(self.text_style()).underline = None;
        self
    }
    ...
    fn text_decoration_color(mut self, color: impl Into<Hsla>) -> Self {
        let style = ensure_text_style(self.text_style());
        let underline = ensure_default(&mut style.underline);
    ...
    fn font_family(mut self, family_name: impl Into<SharedString>) -> Self {
        ensure_text_style(self.text_style()).font_family = Some(family_name.into());
        self
    }
    ...
    fn font(mut self, font: Font) -> Self {
        ...
        let text_style = ensure_text_style(self.text_style());
    ...
    fn line_height(mut self, line_height: impl Into<DefiniteLength>) -> Self {
        ensure_text_style(self.text_style()).line_height = Some(line_height.into());
        self
    }
    ...
    /// Sets transition metadata for state-change animations.
    fn transition(mut self, transition: Transition) -> Self {
        self.style().transition = Some(transition.into_style());
        self
    }
