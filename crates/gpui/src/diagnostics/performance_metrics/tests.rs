...
fn records_window_scoped_metrics() {
    ...
    assert_eq!(
        lightweight_window.dirty_to_present_average_micros,
        window.dirty_to_present_average_micros
    );
    assert_eq!(
        lightweight_window.dirty_to_present_max_micros,
        window.dirty_to_present_max_micros
    );
    assert_eq!(
