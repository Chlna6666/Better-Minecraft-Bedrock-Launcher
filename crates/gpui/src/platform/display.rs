...
pub trait PlatformDisplay: Send + Sync + Debug {
    ...
    /// Get the visible work area for this display, excluding taskbars, docks, and menu bars.
    ///
    /// Platforms without a distinct work area may use the full display bounds.
