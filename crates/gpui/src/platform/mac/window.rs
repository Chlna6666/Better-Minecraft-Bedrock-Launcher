...
impl MacWindow {
    pub fn open(
        ...
        WindowParams {
            ...
            show,
            display_id,
            window_background: _window_background,
            window_min_size,
            tabbing_identifier,
        }: WindowParams,
        executor: ForegroundExecutor,
...
impl PlatformWindow for MacWindow {
    ...
    fn visibility(&self) -> WindowVisibility {
        mac_window_visibility(&self.0.lock())
    }
    ...
    fn on_visibility_change(&self, callback: Box<dyn FnMut(WindowVisibility)>) {
        ...
        state.last_visibility = Some(mac_window_visibility(&state));
...
fn mac_window_visibility(state: &MacWindowState) -> WindowVisibility {
    ...
    executor
        .spawn({
            ...
            async move {
                ...
                let visibility = mac_window_visibility(&state);
