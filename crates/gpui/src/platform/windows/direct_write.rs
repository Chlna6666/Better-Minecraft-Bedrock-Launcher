...
struct DirectWriteComponents {
    ...
    subpixel_rendering_enabled: bool,
}
...
impl DirectWriteTextSystem {
    pub(crate) fn new(renderer_capabilities: RendererCapabilities) -> Result<Self> {
        ...
        let subpixel_rendering_enabled = renderer_capabilities.text_rasterization
            == TextRasterizationMode::RgbSubpixel
            && get_system_subpixel_rendering();
...
mod tests {
    ...
    #[test]
    fn lays_out_and_rasterizes_grayscale_system_text_for_nova() -> anyhow::Result<()> {
