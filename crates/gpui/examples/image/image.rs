...
use anyhow::Result;
use gpui::{
    App, Application, AssetSource, Bounds, Context, ImageSource, KeyBinding, Menu, MenuItem, Point,
...
fn main() {
    ...
    Application::new()
        ...
        .run(move |cx: &mut App| {
            ...
            if let Err(error) = cx.open_window(window_options, |_, cx| {
                ...
                eprintln!("failed to open image example window: {error:#}");
            }
        });
}
