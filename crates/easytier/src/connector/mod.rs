...
use crate::{
    ...
    tunnel::{
        IpScheme, IpVersion, TunnelConnector, TunnelError, TunnelScheme, ring::RingTunnelConnector,
    ...
    let mut connector: Box<dyn TunnelConnector + 'static> = match scheme {
        TunnelScheme::Ip(scheme) => {
            ...
            let mut connector: Box<dyn TunnelConnector> = match scheme {
                ...
                #[cfg(feature = "quic")]
                IpScheme::Quic => {
                    crate::tunnel::quic::QuicTunnelConnector::new(url, global_ctx.clone()).boxed()
                }
                ...
                IpScheme::Ws | IpScheme::Wss => {
                    crate::tunnel::websocket::WsTunnelConnector::new(url).boxed()
                }
            };
        ...
        #[cfg(unix)]
        TunnelScheme::Unix => crate::tunnel::unix::UnixSocketTunnelConnector::new(url).boxed(),
