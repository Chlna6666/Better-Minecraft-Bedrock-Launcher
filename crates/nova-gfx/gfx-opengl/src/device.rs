...
impl OpenGlDevice {
    /// Returns unavailable until native OpenGL integration is implemented.
    ///
    /// # Errors
    ///
...
fn unavailable<T>() -> Result<T> {
    Err(GfxError::Unavailable(
        "OpenGL backend is not implemented yet".to_string(),
    ))
}

impl GfxBackend for OpenGlDevice {
    const BACKEND_KIND: BackendKind = BackendKind::OpenGl;
}

impl GfxSurfaceDevice for OpenGlDevice {
    type SurfaceTarget = ();
...
impl GfxResourceDevice for OpenGlDevice {
...
impl GfxPipelineDevice for OpenGlDevice {
...
impl GfxCommandDevice for OpenGlDevice {
...
impl GfxSubmissionDevice for OpenGlDevice {
...
impl GfxPresentationDevice for OpenGlDevice {
...
impl GfxDiagnosticsDevice for OpenGlDevice {
