...
use super::{
    ...
    LegacyNumericBlockStateTable, PINNED_BLOCK_STATE_SCHEMA_FILES, load_pinned_block_state_catalog,
...
pub const PINNED_BLOCK_MIGRATION_CORPUS_FILES: &[PinnedCorpusFileSpec] = &[
    ...
    file(
        ...
        "e322f7067c39c7b9331093cad1d7d990edaeae1c",
        19660,
    ),
    file(
        "id_meta_to_nbt/1.9.0.bin",
        "8a7250d38ce159e758aef104fa2619f5985f273a",
        366625,
    ),
    file(
        "id_meta_to_nbt/1.12.0.bin",
        "60fdd271027423fc0cba356230598294b5b1769a",
        325472,
    ),
    file(
        "nbt_upgrade_schema/0001_1.9.0_to_1.10.0.json",
        "b7a1c169185403db9a69a8fd305af5dd45eb1531",
        52603,
    ),
    file(
        "nbt_upgrade_schema/0011_1.10.0_to_1.12.0.json",
        "652e06bda2cec6cff47615eff302dc383ab23602",
        2431,
    ),
    file(
        "nbt_upgrade_schema/0021_1.12.0_to_1.13.0.json",
        "36d79000f98fdf9d8a3934b7759987262cf534bc",
        24079,
    ),
    file(
        "nbt_upgrade_schema/0031_1.13.0_to_1.14.0.json",
        "f363e3152811d774e2b2b865d7a0b50ec36b41a5",
        213,
    ),
    file(
        "nbt_upgrade_schema/0041_1.14.0_to_1.16.0.57_beta.json",
        "cb6da250890d671cc6cb7a99d29a658dcf0f892d",
        736,
    ),
    file(
        "nbt_upgrade_schema/0051_1.16.0.57_beta_to_1.16.0.59_beta.json",
        "fe4917c8c2f8f70cfaab85112ac115242771d9b3",
        707,
    ),
    file(
        "nbt_upgrade_schema/0061_1.16.0.59_beta_to_1.16.0.68_beta.json",
        "1b7cc4e2b436fc629b2f2f0d6f82650a82abb426",
        1693,
    ),
    file(
        "nbt_upgrade_schema/0071_1.16.0_to_1.16.100.json",
        "2aaa532e389281055b396ed00f40415df4beaac9",
        1475,
    ),
    file(
        "nbt_upgrade_schema/0081_1.16.200_to_1.16.210.json",
        "988f4a03ae819a38dc7797def3394a8483a2a2fb",
        472,
    ),
    file(
        "nbt_upgrade_schema/0091_1.17.10_to_1.17.30.json",
        "7c9dbbb414d221eac0c3a23de399bcb7a56eaf5f",
        385,
    ),
    file(
        "nbt_upgrade_schema/0101_1.17.30_to_1.17.40.json",
        "f6b11c869beb5525a527e8a78bf2ac20cc6dc725",
        256,
    ),
    file(
        "nbt_upgrade_schema/0111_1.18.0_to_1.18.10.json",
        "d21428546d69b9949b4d46c6f0566dd8e2860f48",
        9015,
    ),
    file(
        "nbt_upgrade_schema/0121_1.18.10_to_1.18.20.27_beta.json",
        "025916a87eb24b86cab30eff279067ea360564b4",
        600,
    ),
    file(
        "nbt_upgrade_schema/0131_1.18.20.27_beta_to_1.18.30.json",
        "ccb04ca8e00aa62a7bc37f18b4daf3c2c42d9168",
        751,
    ),
    file(
        "nbt_upgrade_schema/0141_1.18.30_to_1.19.0.34_beta.json",
        "55048921dfcf6300e0d2c90e8a2719fa9b0c25a6",
        1573,
    ),
    file(
        "nbt_upgrade_schema/0151_1.19.0.34_beta_to_1.19.20.json",
        "73fa3000352d6eaed71f7bd3da584e119fc00361",
        271,
    ),
    file(
        "nbt_upgrade_schema/0161_1.19.50_to_1.19.60.26_beta.json",
        "05a59baf2fcf4d6c291087e1cb42fd50be952d66",
        233,
    ),
    file(
        "nbt_upgrade_schema/0171_1.19.60_to_1.19.70.26_beta.json",
        "bff8a2c18475cb8506cf6d6842338be2740fa72b",
        387,
    ),
    file(
        "nbt_upgrade_schema/0181_1.19.70_to_1.19.80.24_beta.json",
        "6232cd83b140bdf074ecbd945e3f134b37b7535b",
        606,
    ),
    file(
        "nbt_upgrade_schema/0191_1.19.80.24_beta_to_1.20.0.23_beta.json",
        "77ae52fd6c6451da76d00ea75bd544f08ee55f3b",
        4186,
    ),
    file(
        "nbt_upgrade_schema/0201_1.20.0.23_beta_to_1.20.10.24_beta.json",
        "4afc49d6f35218296bd8cbee022894af6bc09e17",
        2098,
    ),
    file(
        "nbt_upgrade_schema/0211_1.20.10.24_beta_to_1.20.20.23_beta.json",
        "1fea99f5c6d2b6b4187ac396a556dfddfbc98f1e",
        14819,
    ),
    file(
        "nbt_upgrade_schema/0221_1.20.20.23_beta_to_1.20.30.22_beta.json",
        "24f74fe7ca851543ab6d21e6ac2e67f5c3507eac",
        6471,
    ),
    file(
        "nbt_upgrade_schema/0231_1.20.30.22_beta_to_1.20.40.24_beta.json",
        "3c42d33f3318c1603fbf2529208b6459c8e0bda5",
        2205,
    ),
    file(
        "nbt_upgrade_schema/0241_1.20.40.24_beta_to_1.20.50.23_beta.json",
        "e79ccbe5205e455ce52b88dd8ebacb7ff216cbaf",
        666,
    ),
    file(
        "nbt_upgrade_schema/0251_1.20.50.23_beta_to_1.20.60.26_beta.json",
        "873cf64310b22f94e6dc70b3def226390eb10157",
        691,
    ),
    file(
        "nbt_upgrade_schema/0261_1.20.60.26_beta_to_1.20.70.24_beta.json",
        "b6435fb3600e3819d414df06e9c31167ae41fb17",
        1919,
    ),
    file(
        "nbt_upgrade_schema/0271_1.20.70.24_beta_to_1.20.80.24_beta.json",
        "b005ed68afa6fd5a3e3264b1f84e13b39f5b51f2",
        1699,
    ),
    file(
        "nbt_upgrade_schema/0281_1.20.80.24_beta_to_1.21.0.25_beta.json",
        "a38d54f9e6cf570db7448920559410b35267c209",
        2813,
    ),
    file(
        "nbt_upgrade_schema/0291_1.21.0.25_beta_to_1.21.20.24_beta.json",
        "dafe1ee81d2c312ff8733de008e4e50b6a73acf4",
        9139,
    ),
    file(
        "nbt_upgrade_schema/0301_1.21.20.24_beta_to_1.21.30.24_beta.json",
        "246712a14ad6c12475f0e705f0f650371fac5841",
        2467,
    ),
    file(
        "nbt_upgrade_schema/0311_1.21.30.24_beta_to_1.21.40.25_beta.json",
        "269b5b8f0f559e5243941b5ebadc4aa64ff69709",
        2440,
    ),
    file(
        "nbt_upgrade_schema/0321_1.21.50.29_beta_to_1.21.60.28_beta.json",
        "8bb48e0db13bccc7d1a9a63e71ab0f60b2608b06",
        9130,
    ),
    file(
        "nbt_upgrade_schema/0331_1.21.100.23_beta_to_1.21.110.26_beta.json",
        "0641aeab0f616128857653149ff3e110756c1ba9",
        338,
    ),
];
...
fn load_bundle(
    ...
    let mut schema_documents =
        Vec::<(&'static str, String)>::with_capacity(PINNED_BLOCK_STATE_SCHEMA_FILES.len());
...
fn take_file(files: &mut BTreeMap<&'static str, Vec<u8>>, path: &str) -> Result<Vec<u8>> {
...
impl Sha1 {
    ...
    fn update(&mut self, mut input: &[u8]) {
        ...
        while input.len() >= 64 {
            let block: &[u8; 64] = input[..64].try_into().expect("64-byte SHA-1 block slice");
            self.process_block(block);
            input = &input[64..];
        }
        if !input.is_empty() {
...
mod tests {
    ...
    fn git_blob_sha1_matches_pinned_real_schema() {
        let bytes =
            include_bytes!("../../../tests/fixtures/blockstate-schema/0011_1.10.0_to_1.12.0.json");
        assert_eq!(
